...
public class DateUtils {
    ...
    public static Date stringToDate(String str) throws ParseException {  
        DateFormat dateFormat = new SimpleDateFormat(DATE_SMALL_STR);  
        Date date = null;
        if (str != null && str != "") {
    ...
    public static String dateToString2(Date date){  
        DateFormat dateFormat = new SimpleDateFormat(DATE_FULL_STR);  
        String strDate=null;  
        if(date!=null){  
            strDate=dateFormat.format(date);  
        }  
     ...
     * @return
     */
    public static String unixDateToDate(Date date) {
    	if (date != null) {
    		SimpleDateFormat sd = new SimpleDateFormat(DATE_SMALL_STR);
	        sd.setTimeZone(TimeZone.getTimeZone("GMT+8"));
	        return sd.format(new Date(date.getTime()));
		}
    	return "";
    }
