...
<body>
	...
	<form class="layui-form" action="res.do" enctype="multipart/form-data">
		...
		<c:forEach items="${infos }" var="list">
			<div class="layui-form-item">
				...
				<div class="layui-input-block" style="width: 200px;">
					<input type="text" name="userid" value="${list.userName}" class="layui-input" readonly>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">留言</label>
				<div class="layui-input-block" style="width: 4000x">
					<textarea class="layui-textarea" name="message" readonly>${list.message}</textarea>
				</div>
			</div>
			<div class="layui-form-item layui-form-text">
				<label class="layui-form-label">创建时间</label>
				<div class="layui-input-block" style="width: 200px;">
					<input type="text" name="ceratetime" value="${list.ceratetime}" class="layui-input" readonly>
				</div>
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea class="layui-textarea" name="message1"></textarea>
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
