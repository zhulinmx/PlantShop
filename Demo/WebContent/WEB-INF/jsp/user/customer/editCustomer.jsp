...
<html>
	...
	<body>
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="editCustomer.do" enctype="multipart/form-data">
				<div class="layui-form-item">
					<label class="layui-form-label">用户ID</label>
					<div class="layui-input-block" style="width: 200px;">
						<input type="text" name="userid" lay-verify="userid" value="${user.userid}" autocomplete="off" class="layui-input"  readonly>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 200px;">
						<input type="text" name="tellphone" lay-verify="tellphone" value="${user.tellphone}" autocomplete="off" class="layui-input" >
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="birthday" id="birthday" lay-verify="date" value="${dateStr}" onclick="layui.laydate({elem: this})" >
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">备注</label>
					<div class="layui-input-block" style="width: 200px;">
						<input type="text" name="remark" lay-verify="remark" value="${user.remark}" autocomplete="off" class="layui-input" >
					</div>
				</div>
