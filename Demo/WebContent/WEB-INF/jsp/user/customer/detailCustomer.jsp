	...
	<body>
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="" enctype="multipart/form-data">
				...
				<div class="layui-inline">
					<label class="layui-form-label"><font color="red">*</font>加入时间</label>
					<div class="layui-input-block">
						<input type="text" name="birthday" id="birthday" lay-verify="date" value="${dateStr1}" autocomplete="off" class="layui-input" readonly>
					</div>
				</div>
				<div class="layui-form-item">
