	...
	<body>
		<div style="margin: 15px;">
			<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
				<legend>新增人事信息</legend>
			</fieldset>

			<form class="layui-form" action="addAdmin.do" enctype="application/x-www-form-urlencoded;charset=UTF-8">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 200px;">
						<input type="text" name="dep" lay-verify="dep" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label"><font color="red">*</font>入职时间</label>
					<div class="layui-input-block">
						<input type="text" name="jointime" id="jointime" lay-verify="date" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})">
					</div>
				</div>
				<div class="layui-form-item">
