		...
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="addPropagate.do" enctype="multipart/form-data">
				...
				<div class="layui-inline">
						<label class="layui-form-label"><font color="red">*</font>有效日期</label>
						<div class="layui-input-block">
							<input type="text" name="deadlinetime" id="deadlinetime" placeholder="yyyy-mm-dd" class="layui-input" onclick="layui.laydate({elem: this})">
						</div>
				</div>
